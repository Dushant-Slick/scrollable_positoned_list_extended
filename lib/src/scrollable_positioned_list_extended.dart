  ...
  void scrollToMax(
    ...
    _scrollableListState!.widget.reverse
        ? _scrollableListState!
            ._scrollToMin(curve: curve, duration: duration ~/ 2)
        : _scrollableListState!
            ._scrollToMax(curve: curve, duration: duration ~/ 2);
  }
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
                ...
                child: FadeTransition(
                  ...
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child: PositionedList(
                      ...
                      customSliverWidgets: widget.customSliverWidgets,
                    ),
                  ),
                ),
              ),
  ...
  void _scrollToMax({required Curve curve, required Duration duration}) {
  ...
  void _scrollToMin({required Curve curve, required Duration duration}) {
    primary.scrollController.animateTo(
  ...
  void _jumpToMax() {
    primary.scrollController
        .jumpTo(primary.scrollController.position.maxScrollExtent);
  }

  void _jumpToMin() {
    // primary.scrollController.
    primary.scrollController
        .jumpTo(primary.scrollController.position.minScrollExtent);
  }
  ...
  void _scrollListener(
    ...
    primary.scrollController.addListener(() {
      listenPosition.call(ScrollNotifier(
        ...
        positions: primary.scrollController.positions,
      ));
    });
  }
...
class ScrollNotifier {
  ...
  final Iterable<ScrollPosition> positions;
}
